...
<?php include("functions/doctor_reservations.php"); ?>
<!DOCTYPE html>
<html lang="en">
...
<main class="page-content">
						...
						<div class="blog-posts">
							<div class="blog-post">
								...
								<div class="post-image">
									<a href="blog-post-page.html"><img src="images/doctors/<?php echo $row["image"] ?>" alt=""></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 aside-left mt-5 mt-lg-0">
						<div class="side-block">
							...
							<ul class="categories-list">
								<li><a href="#" class="row no-gutters"><p class="mb-0">Price:</p><p><?php echo $row["price"] ?> LE</p></a></li>
								<li><a href="#" class="row no-gutters"><p class="mb-0">Status : </p><p><?php echo $row["status"] ?></p></a></li>
								<li><a href="#" class="row no-gutters"><p class="mb-0">Time of service : </p><p><?php echo $row["time_slot"] ?></p></a></li>
							</ul>
						</div>
						<div class="row my-3">
							<div class="col-12">
						...
						<form action="" method="post">
							<div class="row my-3">
								<div class="col-12">
									<input type="hidden" value="<?php echo $row["id"] ?>" name="doctor_service_id">
									<input type="hidden" value="<?php echo $row["doctor_id"] ?>" name="doctor_id">
									<button <?php echo $disable ?> name="doctor_reservation" class="btn btn-main btn-block">Reserve</button>
								</div>
							</div>
						</form>
					</div>
    ...
    <section class="doctor-profile mt-5">
        <div class="container">
        <?php
                        $doctors = "SELECT * from doctors where doctors.id = ".$row["doctor_id"]." ";
                        $query = mysqli_query($conn,$doctors) or die("Error:".mysqli_error($conn)) ;
                        ...
                        <div class="col-12">
                            <h2 class="text-main text-center">Doctor Details</h2>
                        </div>
                            <div class="col-lg-4">
                                <div class="service-card-style3 p-0 active">
                                    <img src="images/doctors/<?php echo $result["image"] ?>" class="w-100" alt="">
                                    <div class="card-body p-3 text-center">
                                        <h5 class="service-card-name"><?php echo $result["full_name"] ?></h5>
        ...
        <div class="container">
            <div class="row">
                ...
                if(isset($_GET['id'])){
                    ...
                    $sql = "select doctors_rate.message , doctors_rate.scale , users.full_name FROM doctors_rate INNER JOIN users on doctors_rate.user_id = users.id WHERE doctor_service_id = ".$_SESSION['doctor_service_id']." ";
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="" id="review_form">
                        <input type="hidden" name="doctor_service_id" value="<?php echo $_SESSION['doctor_service_id'] ?>">
                        ...
                        <div class="form-group col-md-8 col-12" id="rating-ability-wrapper">
                            ...
                            <button <?php echo $disable ?>  type="submit" name="add_doctor_rate" class="btn btn-primary">Add Rate</button>
                        </div>
