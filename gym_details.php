						...
						<div class="blog-posts">
							<div class="blog-post">
								...
								<div class="post-image">
									<a href="blog-post-page.html"><img src="images/gyms/<?php echo $row["image"] ?>" alt=""></a>
								</div>
        ...
        <div class="container">
            <div class="row">
                ...
                if(isset($_GET['id'])){
                    ...
                    $sql = "select gyms_rate.message , gyms_rate.scale , users.full_name FROM gyms_rate INNER JOIN users on gyms_rate.user_id = users.id WHERE gym_id = ".$_SESSION['gym_id']." ";
            ...
            <div class="row">
                <div class="col-12">
                    <form method="post" action="" id="review_form">
                        <input type="hidden" name="gym_id" value="<?php echo $_SESSION['restaurant_id'] ?>">
                        ...
                        <div class="form-group col-md-8 col-12" id="rating-ability-wrapper">
                            ...
                            <button <?php echo $disable ?>  type="submit" name="add_gym_rate" class="btn btn-primary">Add Rate</button>
                        </div>
