...
<?php include("functions/login_doctor.php"); ?>
            ...
            <div class="col-md-8 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  ...
                  <div class="alert alert-success alert-dismissible w-75 mb-2 m-auto fade show" role="alert">
                      <h5><?= $success ?></h5>
                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12  mb-4">
                                        <h3 class="text-main">Doctor Login</h3>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <h3 class="text-main">Doctor Register</h3>
