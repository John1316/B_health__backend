        ...
        <div class="navbar-wrapper">
            ...
            <div class="collapse navbar-collapse row no-gutters justify-content-end" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav ">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="logout.php"><span class="mr-1 mb-0 user-name text-bold-700">Admin</span></a></li>
                </ul>
            </div>
            </div>
        </div>
