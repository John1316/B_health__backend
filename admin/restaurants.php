            ...
            <div class="content-body">
                ...
                <section id="dom">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header bg-primary bg-darken-2 white text-center card-title-bold text-capitalize">Restaurant</div>
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard table-responsive">
                                        <button data-toggle="modal" data-target="#add" class="btn btn-primary mb-1">Add Resturant</button>
                                        <?php if(isset($restaurants_added)): ?>
                                        <div class="alert alert-success alert-dismissible mt-1 fade show" role="alert">
                                            <h5><?= $restaurants_added ?></h5>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <?php endif; ?>
                                        <?php if(isset($restaurants_updated)): ?>
                                        <div class="alert alert-success alert-dismissible mt-1 fade show" role="alert">
                                            <h5><?= $restaurants_updated ?></h5>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <?php endif; ?>
                                        <?php if(isset($restaurants_deleted)): ?>
                                        <div class="alert alert-danger alert-dismissible mt-1 fade show" role="alert">
                                            <h5><?= $restaurants_deleted ?></h5>
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        ...
                                        <tbody>
                                            <?php
                                            $restaurants = "SELECT restaurants.id, restaurants.image,restaurants.location,  restaurants.name, restaurants.description , restaurants.area_id, area.area_name  FROM restaurants INNER JOIN area on area.id = restaurants.area_id";
                                            $query = mysqli_query($conn,$restaurants) or die("Error:".mysqli_error($conn)) ;
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="../images/restaurants/<?php echo $result["image"]; ?>" height="100px" width="100px" alt=""></td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel1">Edit restaurants</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                                <div class="row">
                                                                    <input type="hidden" name="restaurant_id" value="<?php echo $result["id"] ?>">
                                                                    <div class="col-lg-6">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit" name="update_restaurants" class="btn btn-primary">Edit restaurants</button>
                                            ...
                                            <div class="modal fade text-left" id="delete<?php echo $result["id"]; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myModalLabel1">Delete restaurants</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="" method="post">
                                                                <div class="row">
                                                                    <input type="hidden" name="restaurants_delete_id" value="<?php echo $result["id"]; ?>">
                                                                    <div class="col-12">

                                                                        <p>Do you want to delete restaurants <?php echo $result["name"]; ?></p>
                                                                    </div>
                                                                </div>
                                                                
                                                                <div class="modal-footer border-top-0">
                                                                    <button type="submit" name="delete_restaurants" class="btn btn-danger">Delete restaurants</button>
                ...
                <div class="modal" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Add Restaurants</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="add_resturant" class="btn btn-primary">Add Resturants</button>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                </div>
                            </form>
                        </div>
