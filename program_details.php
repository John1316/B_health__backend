...
<head>
	...
	<title>Be Health | <?php echo $row["name"] ?></title>
	<!-- Stylesheets -->
...
<main class="page-content">
	<section class="section page-content-first">
			<div class="container">
				...
				<div class="row">
						...
						<div class="blog-posts">
							<div class="blog-post">
								...
								<div class="post-image">
									<a href="#"><img src="images/programs/<?php echo $row["image"] ?>" alt=""></a>
								</div>
					...
					<div class="col-lg-3 aside-left mt-5 mt-lg-0">
						...
						<form action="" method="post">
							<div class="row my-3">
								<div class="col-12">
									<button <?php echo $disable ?> name="user_reservation" class="btn btn-main btn-block">Reserve</button>
								</div>
							</div>
						</form>
				...
				<div class="row my-3">
					<?php
					// $programs_rate = "select programs_rate.message , programs_rate.scale , users.full_name FROM programs_rate INNER JOIN users on programs_rate.user_id = users.id WHERE program_id = ".$_SESSION['program_id']." ";
					
                    $programs_rate = "select programs_rate.message , programs_rate.scale , users.full_name FROM programs_rate INNER JOIN users on programs_rate.user_id = users.id WHERE program_id = ".$_SESSION['program_id']."";
                    $result = $conn->query($programs_rate) or die("failed to query".mysqli_error($conn));
                ...
                <div class="col-12">
                    <form method="post" action="" id="review_form">
                        ...
                        <div class="form-group col-md-8 col-12" id="rating-ability-wrapper">
                            ...
                            <button <?php echo $disable ?>  type="submit" name="add_rate" class="btn btn-primary">Add Rate</button>
                        </div>
